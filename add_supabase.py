...
async function loadCars() {
  ...
  if (error) { console.error('Ошибка загрузки авто:', error); return; }
...
<a class="iva-item-sliderLink-hO7qj" data-marker="item-photo-sliderLink" itemprop="url" href="#" target="_blank" rel="noopener noreferrer"><div class="photo-slider-root-_kL8M photo-slider-roundCorners-j8Wrb" data-marker="item-photo"><div class="photo-slider-photoSlider-b9P07 photo-slider-aspect-ratio-1-1-aIB4A"><ul class="photo-slider-list-PxsU9"><li class="photo-slider-list-item-X8gjp photo-slider-dotsCounter-XHmkX"><div class="photo-slider-item-Zbpsa photo-slider-keepImageRatio-BgO73">
<img alt="${car.title}" class="photo-slider-image-PWbIy" itemprop="image" importance="high" src="${car.image_url}"></div></li></ul></div></div></a>
${badgeHtml}
